...
import { X, Upload, Edit2, Download } from 'lucide-react';
      ...
      <div className="w-full max-w-md bg-[#0F1012] border border-white/10 rounded-2xl p-6 shadow-2xl relative animate-in slide-in-from-bottom-5 fade-in duration-200">
        ...
        <div className="space-y-5">
          ...
          <div className="flex flex-col items-center mb-4">
              ...
              <span className="text-[10px] text-[#555] mt-2">Click to change (Max 100KB)</span>
          ...
          <Button onClick={handleSave} className="w-full mt-2" isLoading={loading}>
            Save Profile
          </Button>
        </div>
      </div>
