			...
			<div className="relative z-10 flex flex-col items-center">
				<div className="w-full max-w-4xl px-4 sm:px-6">
					...
					<div className="sticky top-6 z-50 mb-12 flex flex-col items-center gap-4 animate-in slide-in-from-top-4 duration-700">
						<div className="w-full max-w-2xl bg-white/1 backdrop-blur-2xl border border-white/5 p-2 rounded-2xl shadow-2xl flex flex-col  gap-2">
					...
					<footer className="mt-24 text-center">
						...
						<p className="text-[#7e7e7e] text-[9px] font-bold mb-4 transition-colors underline underline-offset-4 decoration-[#5E6AD2]/30">
							<Link to="/">
								Add your own cafe/restaurant menu at{' '}
								<span className="text-[#5E6AD2]">Cafe Kothay</span>
							</Link>
						</p>
						<p className="text-[10px] text-[#444] font-medium tracking-tight">
							...
							<a
								...
								className="text-[#5E6AD2] hover:text-[#7C87E8] transition-colors underline underline-offset-4 decoration-[#5E6AD2]/30"
							>
								Mahadi Hasan
							</a>
						</p>
